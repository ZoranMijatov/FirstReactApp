...
import Cart from './GalaxyStore/Cart';
        ...
        <Router>
          <div> 
            <div className="HeroImg" style={{backgroundImage: loginSuccess ? `url(${LoggedIn})` : `url(${LoginBackground})`}}>
                <div className="Menu">
                  <svg height="100" width="190" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 90" className="iconLeft">
                  ...
                  <div>
                  {loginSuccess ? <div className="Navbar-Right"><Redirect to = "/dashboard"></Redirect><LightModeToggle /><Cart /><Logout handleClick={handleLogout} /></div> : <Link to="/login"><Login /></Link>}
