    ...
    <Router>
      <div className="App"> 
        <div className="HeroImg">
            <div className="Menu">
              <svg height="100" width="190" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 90" class="iconLeft">
              ...
              <div>
              {loginSuccess ? <><Redirect to = "/dashboard"></Redirect><LightModeToggle /><Logout handleClick={handleLogout} /></> : <Link to="/login"><Login /></Link>}
              {loginSuccess ? [] : <Link to="/"><Register /></Link>}
              </div>
            </div>
