  ...
  return (
    <Styled.MainWrapper>
      ...
      <form onSubmit={handleNewInfo}>
        ...
        <svg
          onClick={() => { setEditEmail(!editEmail); EmailInput.current.focus()}}
          xmlns="http://www.w3.org/2000/svg"
