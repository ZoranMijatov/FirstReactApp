  ...
  switch (action.type) {
    case "ADD_TO_CART":
      ...
      case "REMOVE_FROM_CART":
        let productRemoved = state.addedProducts.find(product => action.id === product.id);
...
export default combineReducers({ preferences, cartReducer, counter });
